  ...
  return (
    <div className="fixed inset-0 bg-gray-50 text-gray-900 flex flex-col items-center z-[2000] overflow-hidden select-none font-sans">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <div className="absolute top-0 right-0 w-[40vmax] h-[40vmax] bg-primary-100 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2" />
        <div className="absolute bottom-0 left-0 w-[40vmax] h-[40vmax] bg-accent-100 rounded-full blur-[120px] translate-y-1/2 -translate-x-1/2" />
      </div>

      {/* Exit Button */}
      <button 
        onClick={onExit}
        className="absolute top-6 left-6 bg-white/80 backdrop-blur-sm shadow-sm border border-gray-200 text-gray-500 hover:text-primary-600 px-5 py-2.5 rounded-xl font-bold text-[10px] tracking-widest uppercase transition-all flex items-center gap-2 z-50 group"
      >
      ...
      <div className="w-full flex flex-col items-center gap-2 py-10 z-10 flex-shrink-0 animate-in fade-in slide-in-from-top-4 duration-700">
        ...
        <div className="flex items-center justify-center gap-3 px-8 py-3 bg-white/80 backdrop-blur-md rounded-full border border-gray-200 shadow-sm">
      ...
      <div className="w-full flex-1 flex gap-6 px-6 pb-10 z-10 overflow-hidden">
        {[0, 1, 2].map(index => {
          ...
          return (
            <div key={index} className="flex-1 flex flex-col items-center justify-center relative bg-white/60 backdrop-blur-sm rounded-[40px] border border-white/40 shadow-xl overflow-hidden transition-all duration-500">
              ...
              {!result && !unknown ? (
                <div className="flex flex-col items-center justify-center space-y-8 animate-in fade-in zoom-in duration-700">
                  <div className="w-[20vh] h-[20vh] bg-white rounded-[40px] flex items-center justify-center relative border border-gray-100 shadow-2xl">
                    <div className="absolute inset-0 bg-primary-100 rounded-[40px] animate-ping opacity-20" />
                ...
                <div className="w-full h-full p-10 flex flex-col justify-center text-center space-y-8 animate-in slide-in-from-bottom-10 duration-500 border-t-[12px] border-success-600 bg-white">
                  <div className="flex justify-center">
                    <div className={`inline-flex items-center gap-3 px-6 py-2.5 rounded-full ${getStatusColor(result)} font-black shadow-sm border`}>
                  ...
                  <div className="flex flex-col items-center space-y-8">
                    ...
                    <div className="relative">
                      <div className="w-[22vh] h-[22vh] rounded-[48px] overflow-hidden border-8 border-gray-50 shadow-2xl">
                        <img 
                      ...
                      <div className="absolute -bottom-3 -right-3 w-12 h-12 bg-success-500 rounded-full border-4 border-white flex items-center justify-center shadow-lg">
                    ...
                    <div className="space-y-6">
                      <div className="space-y-2">
                        ...
                        <div className="inline-block text-[12px] font-black text-gray-500 uppercase tracking-[0.2em] bg-gray-50 px-6 py-2.5 rounded-full border border-gray-200">
                  ...
                  {result.isDuplicate && (
                    <div className="bg-accent-50 rounded-xl py-3 px-6 inline-block border border-accent-100">
                ...
                <div className="w-full h-full p-10 flex flex-col justify-center text-center space-y-8 animate-in shake duration-500 border-b-[12px] border-accent-600 bg-white">
                  <div className="w-[15vh] h-[15vh] bg-accent-50 rounded-[40px] flex items-center justify-center mx-auto border border-accent-100 shadow-inner">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-1.5 w-16 bg-accent-100 rounded-full mx-auto" />
