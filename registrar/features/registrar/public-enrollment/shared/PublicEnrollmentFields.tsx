...
export function YearPairField({ startYear, endYear, onStartYearChange, onEndYearChange }: YearPairFieldProps) {
  return (
    <div className="year-pair-field">
      <div className="year-pair-field__label-wrap">
        <span className="year-pair-field__label">Last School Year Attended (Previous S.Y.)</span>
      </div>
      <label className="floating-field">
        <div className="floating-field__control">
      ...
      <span className="year-pair-field__divider">-</span>
      <label className="floating-field">
        <div className="floating-field__control">
