...
const buildDraft = (student: Student, activeSchoolYearLabel: string, latestSubmissionPayload?: Record<string, any>): LearnerModalDraft => {
  ...
  return {
    ...
    learnerContact: firstNonEmpty(student.contactNumber, submissionPayload.learnerContact, payload.learnerContact, payload.guardianContact),
    ...
    guardianContact: firstNonEmpty(student.guardian_contact, submissionPayload.guardianContact, payload.guardianContact),
    ...
    const hydrate = async () => {
      ...
      try {
        ...
        const dbStudent: Student = {
          ...
          guardian_contact: String((data as any).guardian_contact || ''),
          ...
          <button type="button" className="modal-dialog__primary" onClick={onClose}>Cancel</button>
            ...
            onClick={async () => {
              ...
              const result = await onSubmit(student.id, {
                ...
                guardian_contact: latestDraft.guardianContact.trim(),
